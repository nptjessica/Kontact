...
var AccountController = function (userModel, session, userSession, mailer) {
    ...
    this.crypto = require('crypto'); //JavaScript implementations of standard and secure cryptographic algorithms.
    this.uuid = require('node-uuid'); //Generate RFC4122 version 1 or version 4 UUIDs
